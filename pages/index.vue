<template>
  <div
    class="flex flex-col space-y-6 md:h-128 md:flex-row md:items-center md:space-x-6"
  >
    <div class="w-full md:w-1/2">
      <div>
        ...
        >
          ...
          My name is M.Igamoto🙋‍♂️<br />
          I'm a front-end engineer💻
        </h1>
        <p class="mt-2 text-gray-600 dark:text-gray-300">
          This place is a site for people to learn about various things about
          me. Please enjoy!
        </p>
        <div class="grid gap-6 mt-8 sm:grid-cols-2">
          ...
          >
            <div class="w-8">
              <img src="https://img.icons8.com/fluent/96/000000/company.png" />
            </div>

            <span>I work in Nagoya</span>
          </div>
          ...
          >
            <div class="w-8">
              <img src="https://img.icons8.com/fluent/96/000000/home.png" />
            </div>

            <span>I live in Gifu</span>
          </div>
          ...
          >
            ...
            <span>I like to write Vue.js</span>
          </div>
          ...
          >
            <div class="w-8">
              <img src="https://img.icons8.com/fluent/96/000000/sedan.png" />
            </div>

            <span>I like to drive a car</span>
          </div>
          ...
          >
            <div class="w-8">
              <img src="https://img.icons8.com/fluent/96/000000/hachiko.png" />
            </div>

            <span>I prefer dogs to cats</span>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        ...
        <g opacity="0.8">
          ...
          <line
            ...
            stroke-width="3"
          />
          <circle cx="330.04" cy="290.49" r="18.25" fill="#6c63ff" />
          <circle cx="442.29" cy="236.3" r="18.25" fill="#3acc6c" />
          <circle cx="442.29" cy="290.49" r="18.25" fill="#6c63ff" />
